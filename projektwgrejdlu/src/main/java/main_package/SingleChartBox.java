...
public class SingleChartBox extends VBox {
    ...
    public SingleChartBox(String chartName, String xAxisName, double yDataToAdd) {
        super();
        this.xAxis.setLabel(xAxisName);
        this.series.setName(chartName);
        this.yDataToAdd = yDataToAdd;
        this.series.getData().add(new XYChart.Data(statistics.getDay(), yDataToAdd));
    ...
    public void updateChart(double yDataToAdd) {
        XYChart.Data newData = new XYChart.Data(statistics.getDay(), yDataToAdd);
        this.yDataToAdd = yDataToAdd;
